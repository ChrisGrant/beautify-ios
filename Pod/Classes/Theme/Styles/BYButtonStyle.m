...
+(BYButtonStyle*)defaultCustomStyle {
    ...
    style.title = [BYText textWithFont:[BYFont new] color:[UIColor whiteColor]];
...
+(BYButtonStyle*)defaultSystemStyle {
    ...
    if(SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        ...
        style.title = [BYText textWithFont:[BYFont fontWithName:@"Helvetica-Bold" andSize:15.0f]
        ...
        BYGradientStop *stop1 = [BYGradientStop stopWithColor:[UIColor colorWithRed:1.0f/255.0f green:93.0f/255.0f blue:230.0f/255.0f alpha:1.0f] at:1.0];
        BYGradientStop *stop2 = [BYGradientStop stopWithColor:[UIColor colorWithRed:5.0f/255.0f green:139.0f/255.0f blue:245.0f/255.0f alpha:1.0f] at:0.0];
        highlightedBGSetter.value = [BYGradient gradientWithStops:@[stop1, stop2]];
        ...
        highlightTextColorSetter.value = [BYText textWithFont:[BYFont fontWithName:@"Helvetica-Bold" andSize:15.0f]
