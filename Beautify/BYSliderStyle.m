...
+(BYSliderStyle*)defaultStyle {
    ...
    if(SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        ...
        style.thumbOuterShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 2) radius:4.0 color:[UIColor colorWithWhite:0.0 alpha:0.5] isInset:NO]];
    }
    else {
        ...
        style.barInnerShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 3) radius:6.0 color:[UIColor colorWithWhite:0.0 alpha:0.9] isInset:YES],
                                  [[BYShadow alloc] initWithOffset:CGSizeMake(0, 1) radius:1.0 color:[UIColor colorWithWhite:0 alpha:0.5f] isInset:YES],
                                  ];
        ...
        style.thumbOuterShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 1) radius:2.0 color:[UIColor colorWithWhite:0.0 alpha:0.8] isInset:NO]];
        style.thumbInnerShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 1) radius:1.0 color:[UIColor whiteColor] isInset:YES]];
    }
    return style;
}
