...
// See here https://github.com/mikeho/QSUtilities/blob/master/QSStrings.h for base 64 methods.
...
+(UIImage*)imageFromBase64String:(NSString*)string {
    ...
    if(string.length > 22) {
        ...
        if(stringComponents.count == 2) {
            NSData *data = [self decodeBase64WithString:stringComponents[1]];
...
+(NSString*)base64StringFromUIImage:(UIImage*)image {
    ...
    NSString *s = [UIImage encodeBase64WithData:data];
