...
@implementation SCTableViewCellRenderer {
    SCControlRenderingLayer* _selectedLayer;
...
-(void)setup:(UITableViewCell*)cell theme:(SCTheme*)theme {
    ...
    _selectedLayer = [[SCControlRenderingLayer alloc] initWithRenderer:self state:UIControlStateHighlighted];
...
-(void)configureSelectedView {
    ...
    SCNineBoxedImage* backgroundImage = [self propertyValueForName:@"backgroundImage" forState:UIControlStateHighlighted];
