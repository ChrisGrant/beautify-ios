...
+(BYSwitchStyle*)defaultStyle {
    ...
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        ...
        style.thumbOuterShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 0) radius:3 color:[UIColor colorWithWhite:0.0 alpha:0.5] isInset:NO]];
    }
    else {
        ...
        style.innerShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 0) radius:4 color:[UIColor blackColor] isInset:YES]];
        ...
        style.thumbInnerShadows = @[[[BYShadow alloc] initWithOffset:CGSizeMake(0, 0) radius:2.0 color:[UIColor whiteColor] isInset:YES]];
