...
-(void)testSizeFromDictionaryWithValidSizes {
    ...
    validDict = @{@"x": @"", @"y": @""};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:validDict].CGSizeValue, CGSizeZero), @"Empty values dictionary - size should be zero");
    
    validDict = @{@"x": @"10", @"y": @"10"};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:validDict].CGSizeValue, CGSizeMake(10, 10)), @"This should be a valid dictionary");
    
    validDict = @{@"y": @"120", @"x": @"5"};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:validDict].CGSizeValue, CGSizeMake(5, 120)), @"This should be a valid dictionary");
    
    validDict = @{@"x": @"2"};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:validDict].CGSizeValue, CGSizeMake(2, 0)), @"This should be a valid dictionary");
    
    validDict = @{@"y": @"9"};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:validDict].CGSizeValue, CGSizeMake(0, 9)), @"This should be a valid dictionary");
}

-(void)testSizeFromDictionaryWithInvalidSizes {
    NSDictionary *invalidDict = [NSDictionary new];
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:invalidDict].CGSizeValue, CGSizeZero), @"Empty dictionary - size should be zero");
    
    invalidDict = @{@"x": @"", @"y": @""};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:invalidDict].CGSizeValue, CGSizeZero), @"Empty values dictionary - size should be zero");
    
    invalidDict = @{@"x": @"", @"y": @""};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:invalidDict].CGSizeValue, CGSizeZero), @"Empty values dictionary - size should be zero");
    
    invalidDict = @{@"x": @"a", @"y": @"a"};
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:invalidDict].CGSizeValue, CGSizeZero), @"Invalid values in dictionary - size should be zero");
...
-(void)testSizeFromDictionaryWithNoDictionary {
    XCTAssertTrue(CGSizeEqualToSize([_valueTransformer CGSizeFromNSDictionary:nil].CGSizeValue, CGSizeZero), @"Without a dictionary, size should be CGSizeZero");
}
...
-(void)testValidImageStringReturnsUIImage {
    ...
    XCTAssertTrue(CGSizeEqualToSize(image.size, CGSizeMake(15, 15)), @"Image should be 15x15");
}
